    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">YIGITHANGUMUS<sup>2.0</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if (Request::segment(2) == 'makaleler') show @endif"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if (Request::segment(2) == 'makaleler' and Request::segment(3) == 'olustur')  @endif"
            ...
            <li class="nav-item">
                <a class="nav-link" @if (Request::segment(2) == 'kategoriler') style="color:white !important;" @endif
                    href="{{ route('admin.category.index') }}">
                    <i @if (Request::segment(2) == 'kategoriler') style="color:white !important;" @endif"
            ...
            <li class="nav-item">
                ...
                <div id="collapsePage" class="collapse @if (Request::segment(2) == 'sayfalar') show @endif"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if (Request::segment(2) == 'sayfalar' and Request::segment(3) == 'olustur')  @endif"
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="{{ asset('back/') }}/https://source.unsplash.com/Mv9hjnEUHR4/60x60"
                                            alt="...">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div>
